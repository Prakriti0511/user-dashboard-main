    ...
    <div className="w-full bg-background text-foreground h-full rounded-lg">
      <div className="flex justify-between items-center lg:block">
        ...
        <ul className="py-2 px-1 flex items-center justify-evenly lg:block">
          <li className={`${isCurrentPage('/ac') ? 'bg-neutral-800' : 'bg-background'} hover:bg-neutral-900 transition rounded-lg mx-1 my-1`}>
            <Link href="/activities">
              <span className="block text-sm lg:text-base px-4 py-2 lg:px-6 lg:py-3">User Activities</span>
            </Link>
          </li>
